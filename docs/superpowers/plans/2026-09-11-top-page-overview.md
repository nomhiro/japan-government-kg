...
## Task 6(最後。切ってよい): 「たとえば、こう辿れます」

**この節だけは新しいCQ2本が要る**(最も多くの事業の根拠になっている法令、
最も多くの事業に支出先として現れる法人)。**原則1に照らして、
ここまでで十分なら作らない判断があり得る。**
着手する場合はTask 1と同じ手順でCQ19/CQ20を足してから、
`overview.ts`に節を足す。
