...
| 項目 | 本番配信中(2026-08-28) | 新(2026-09-11) |
|---|---:|---:|
...
**本番のACAは`2026-08-28-d2-recipient-category-v2`を配信しており、
資金の流れ(裁定B97)と予算履歴(裁定B99)はまだ本番に載っていない。**
載せるにはリリース公開と配信イメージの作り直しが必要で、
**これは外向きの操作なので利用者の意図表明を待つ。**
