...
export interface components {
    schemas: {
        ...
        OverviewResponse: {
            ...
            /** Release Freshness */
            release_freshness: components["schemas"]["ReleaseFreshness"][];
            /** Request And Initial */
        ...
        /**
         * ReleaseFreshness
         * @description CQ10の1行。KGのこのリリースが、あるソースについていつ時点のデータを含むか。
         *
         ...
         * @description CQ20の1行。**要求額がそのまま付いた事業の件数、および同じ母集団の金額。**
         *
