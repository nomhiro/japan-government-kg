...
# 既定値は**実在の対応**(2026-08-23 に実データのCQ実行で確認):
#   厚生労働省=6000012070001 / 総務省=2000012020001 / 財務省=8000012050001
# 以前は実在しそうに見える偽の番号を使っており、CQクエリにまで焼き込まれて
# 実データで0件になった(円環)。架空の主体には 9999999999999 のような
# 明らかに合成と分かる番号を使い、実在の番号と偽の名前の組を作らないこと。
def zenken_row(
    houjin_bangou: str = "6000012070001",
    name: str = "厚生労働省",
    kind: str = "101",
    prefecture: str = "東京都",
    city: str = "千代田区",
